...
class OAuth2Login(object):
  ...
  def init_app(self, app):
    ...
    esta funcion obtiene cada uno de las tokens de los 
    proveedores.
  ...
  def authorization_url(self, **kwargs):
    """
    Esta función obtiene la sesión en el contexto actual de la clase instanciada.
    """
    sess = self.session()
  ...
  def get_token(self):
    ...
    """
    Esta función obtiene el token de acceso utilizando el endpoint definido en 'token_url'
